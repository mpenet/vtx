...
{:test-col-widths-ansi-header test-col-widths-ansi-header
 ...
 :test-sort-rows-asc test-sort-rows-asc
 :test-sort-rows-by-col2 test-sort-rows-by-col2
 :test-sort-rows-desc test-sort-rows-desc
 :test-sort-rows-empty test-sort-rows-empty
 :test-sort-rows-numeric test-sort-rows-numeric
 :test-sort-rows-preserves-original test-sort-rows-preserves-original}
