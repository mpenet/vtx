...
(local tabs-m (require "tiki.widget.tabs"))
...
(fn test-tab-bar-active-has-brackets []
  (let [bar (ansi.strip (tabs-m.render-tab-bar tab-list 1 opts))]
    (faith.is (: bar "find" "[ Tab1 ]" 1 true))))

(fn test-tab-bar-inactive-no-brackets []
  (let [bar (ansi.strip (tabs-m.render-tab-bar tab-list 1 opts))]
...
{:test-tab-bar-active-has-brackets test-tab-bar-active-has-brackets
 ...
 :test-tab-bar-inactive-no-brackets test-tab-bar-inactive-no-brackets
